...
public class RentalBean implements Serializable {
	...
	public RentalBean(int _iRenatalID, int _iUserID, int _iBookID, Date _dRentalDate, Date _dFixedDate,
			Date _dReturnDate, String _strRemarks) {
		fm = new SimpleDateFormat("yyyy/MM/dd");
		iRentalID = _iRenatalID;
		iUserID = _iUserID;
		iBookID = _iBookID;
	...
	public int getiRentalID() {
		return iRentalID;
	}

	public void setiRentalID(int iRentalID) {
		this.iRentalID = iRentalID;
	}
	...
	public String getdRentalDate() {
		return dRentalDate;
	}

	public void setdRentalDate(Date dRentalDate) {
		this.dRentalDate = fm.format(dRentalDate);
	}

	public String getdFixedDate() {
		return dFixedDate;
	}

	public void setdFixedDate(Date dFixedDate) {
		this.dFixedDate = fm.format(dFixedDate);
	}
	...
	public void setdReturnDate(Date dReturnDate) {
		this.dReturnDate = fm.format(dReturnDate);
	}
