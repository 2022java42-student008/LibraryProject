	...
	<div class="box">
		<form action="/LibraryProject/StockAddServlet" method="post">
			<label for="isbn">ISBN番号</label> 
				<input type="text"placeholder="ISBN番号を入力" name="ISBN" size="15" maxlength="13"required align="center"> <br> <br> 
			<label for="bookname">資料名</label> 
				<input type="text" placeholder="資料名を入力"name="title" size="80" required> <br> <br> 
			<label for="author">著者名</label> 
				<input type="text" placeholder="著者名を入力" name="author" size="50" required> <br> <br> 
			<label for="publisher">出版社</label> 
				<input type="text" placeholder="出版者名を入力" name="publisher" size="50" required> <br> <br>
			<label for="publishdate">出版年月日</label> 
				<input type="date" placeholder="出版年月日を入力" name="publish_date" required> <br><br> 
