...
<html>
	...
	<a href="/LibraryProject/TopMenu.html?Top">トップメニュー</a><br>
		...
		<form action="../CreateUserServlet" method="post">
			<table border="1">
				<tr><td><input type="hidden" name="name" value=${CreateUser.name}>			氏名</td><td>${param.name}</td></tr>
				<tr><td><input type="hidden" name="post" value=${CreateUser.post}>			郵便番号</td><td>${param.post}</td></tr>
				...
				<tr><td><input type="hidden" name="indate" value=${CreateUser.indate}>		入会年月日</td><td>${param.indate}</td></tr>
			</table>
			上記の内容で登録しますか？<br>
